...
if (isset($_POST['signup'])) {
	...
	if ($row > 0) {
		...
		$msg = mysqli_query($con, "insert into users(fname,lname,email,password,contactno, usr_typ, stat_code) values('$fname','$lname','$email','$enc_password','$contact','landlords', 1)");
					...
					<div class="tab-2 resp-tab-content" aria-labelledby="tab_item-1">
						<div class="facts">
							<div class="login">
								...
								<form name="login" action="" method="post">
									<input type="text" class="text" name="femail" value=""
										placeholder="Enter your registered email" required><a href="#"
										class=" icon email"></a>
